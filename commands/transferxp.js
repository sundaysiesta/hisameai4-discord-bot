...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('transferxp')
        .setDescription('BANされたアカウントのXPを新しいアカウントに引き継ぎます。(管理者限定)')
